...
const translations: Record<Language, TranslationDictionary> = {
  ...
  pl: {
    ...
    card3Bullet4: "Formaty skrojone pod LinkedIn, YouTube, TikTok, X i Instagram",
    card3Cta: "Zaprezentuj Swój SaaS",

    roiCalculatorTag: "KALKULATOR",
    ...
    roiSliderImpressions: "Wyświetlenia w ciągu miesiąca",
    roiSliderOfferPrice: "Cena Twojego pakietu",
    roiSliderCloseRate: "Średnia konwersja",
    roiDiagnosticAdSpend: "Płatne reklamy pożerają budżet i przestają działać w sekundę po odpięciu karty. Organiczny content buduje trwały autorytet, który dowozi Ci ciepłe leady długo po publikacji. ",
    
    roiCalculatedPipeline: "// TWÓJ NOWY LEJEK SPRZEDAŻOWY",
    roiProjectedRevenue: "Przybliżony miesięczny przychód",
    roiBasedOnDealsPost: "Przy założeniu {closedDeals} zamkniętych transakcji z {discoveryCallsBooked} pozyskanych leadów.",
    ...
    roiAdEquivalentClicksSub: "Darmowe kliknięcia z organicznego contentu",
    ...
    roiGuarantee3: "Zgodność z Warunkami platform społecznościowych",
  },
};
